---
title: "CLI Overview"
description: "Add TermUI components to your project from the command line with @termuijs/cli. Run npx termuijs add <name> to copy a component's source and install its dependencies."
---
